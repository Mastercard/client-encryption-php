...
class FieldLevelEncryptionTest extends TestCase {
    ...
    public function testDecryptPayload_InteroperabilityTest() {
        ...
        $config = TestUtils::getTestFieldLevelEncryptionConfigBuilder()
            ->withDecryptionKey(file_get_contents(__DIR__ . "/../../resources/keys/pkcs1/test_key_pkcs1-2048.pem"))
            ->withDecryptionPath('$', '$')
    ...
    public function testDecryptPayload_ShouldThrowEncryptionException_WhenDecryptionErrorOccurs() {
        ...
        $config = TestUtils::getTestFieldLevelEncryptionConfigBuilder()
            ...
            ->withOaepPaddingDigestAlgorithm('SHA-256')
            // Not the right key
            ->withDecryptionKey(\file_get_contents(__DIR__ . "/../../resources/keys/pkcs12/test_key.p12"), 'Password1')
            ->build();
